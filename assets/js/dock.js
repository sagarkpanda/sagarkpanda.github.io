...
(function () {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", function (e) {
      ...
      // Fix: if the image lightbox is open, this button should just close
      // the image, not navigate away from the post.
      if (document.body.classList.contains("gallery-lightbox-open") && window.imageGallery?.lightbox?.close) {
        window.imageGallery.lightbox.close();
        return;
      }
